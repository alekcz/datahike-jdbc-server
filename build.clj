...
;; customization start
(def lib 'alekcz/datahike-jdbc-server)
...
;; customization start
(def image (format "docker.io/alekcz/datahike-jdbc-server:%s" version))
(def latest-image (format "docker.io/alekcz/datahike-jdbc-server:latest"))
;; customization end
